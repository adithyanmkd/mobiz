  ...
  return (
    <div className="bg-[#F2F5EF]">
      <div className="mx-auto max-w-screen-xl px-4 py-[32px] md:px-0 lg:px-12">
        <div className="mx-auto max-w-[375px] pb-4 text-[30px] font-medium sm:max-w-[440px] sm:text-[36px] md:max-w-[600px] lg:mb-5 lg:mr-auto lg:max-w-screen-xl lg:text-4xl">
          <h1 className="mr-auto max-w-[550px] leading-[120%]">Why Us?</h1>
        </div>
        <div className="lg:px-12">
          <div className="mx-auto my-[16px] h-px w-full max-w-[324px] bg-black sm:max-w-[440px] md:max-w-[600px] lg:max-w-[850px]"></div>
        </div>
        {ourValues.map((data) => (
